// ============================================================
// Tour Transalp 2026 — trip manifest
// Seven-day road cycling stage race across the Alps.
// Assets are root-hosted (assetBase: "") to preserve the
// original Vercel deployment paths.
// ============================================================
import type {
  TripManifest,
  EventMetadata,
