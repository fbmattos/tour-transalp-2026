...
const MobileOverview: React.FC<{ stage: StageWithGpx }> = ({ stage }) => {
  ...
  <div className="flex flex-col gap-4">
    ...
    <div>
      <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-white/30">Stage Summary</p>
      <p className="text-sm leading-relaxed text-white/70">{stage.summary}</p>
    </div>

    <div className="grid grid-cols-1 gap-3">
      <div className="rounded-xl border border-red-500/20 bg-red-500/10 p-3">
        <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-red-400/70">Main Risk</p>
        <p className="text-sm leading-relaxed text-white/70">{stage.mainRisk}</p>
      </div>
      <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-3">
        <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-blue-400/70">Pacing Advice</p>
        ...
        {activeMobileView === 'map' && (
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <span className="min-w-0 flex-1 truncate text-xs text-white/50">{routeStatus}</span>
              <button
                onClick={() => setShowAll(!showAll)}
